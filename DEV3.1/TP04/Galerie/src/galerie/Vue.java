...
public class Vue extends JFrame {
    ...
    public Vue(){
        ...
        this.label1 = new JLabel(new ImageIcon(loader.getResource("img/im1.jpg")));
        this.label2 = new JLabel(new ImageIcon(loader.getResource("img/im2.jpg")));
        this.label3 = new JLabel(new ImageIcon(loader.getResource("img/im3.jpg")));
